 ...
 * Description:
 * Hint: part of you print will be inside a doubly nested for-loop.
 */
 ...
 * Description:
 * Hint: You will need a doubly nested for-loop.
 *       The value at each index in m will be the same in result.
 */
 ...
 * Description:
 * Hint: result[0][0] = m1[0][0] + m2[0][0].
 *       This will be the procedure for each index in m1 and m2.
 */
 ...
 * Description:
 * Hint: you will need a triple for-loop for this to work.
 *       look at http://tinyurl.com/nthannc for additional matrix help.
 */
 ...
 * Description:
 * Hint: look at http://tinyurl.com/nthannc for additional matrix help.
 */
 ...
 * Description:
 * Hint: you need to use matrix_transpose as part of your check.
